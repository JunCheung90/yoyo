...
var random = {
    ...
    nd_random_in_range: function (data) {
        var r;
        do {
            r = this.normal_distribution(data.mean, data.std);
        } while (r < data.min || r > data.max);

        return r;
    },

    nd_random_contacts_amount: function () {
        return Math.floor(this.nd_random_in_range(Config.contactsAmount));
    },

    nd_random_contacts_repeat_rate: function () {
        return this.nd_random_in_range(Config.contactsRepeatRate);
    },

    nd_random_contacts_similar_repeat_rate: function () {
        return this.nd_random_in_range(Config.contactsSimilarRepeatRate);
    },
