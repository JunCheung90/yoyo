...
var user = {
    ...
    contacts: function () {
        var sourceContacts = [];
        var targetContacts = [];
        var amountOfContact = Random.nd_random_contacts_amount();
        amountOfContact = Math.floor(amountOfContact / 2) * 2;
        for (var i = 0; i < amountOfContact; i++) {
            sourceContacts.push(Helpers.createYoYoUser());
        }

        var repeatRate = Random.nd_random_contacts_repeat_rate();
        var similarRate = Random.nd_random_contacts_similar_repeat_rate();
        var repeatAmount = 0;
        var similarAmount = 0;
